...
//    printf("%s\n",prg_src);
    ...
    ocl->hst.vtx_ec = malloc(  msh->nv_tot*sizeof(float));
    ...
    ocl->dev.vtx_ec = clCreateBuffer(ocl->context, CL_MEM_HOST_READ_ONLY,   msh->ne_tot*sizeof(float), NULL, &ocl->err);
    ...
    ocl->err = clSetKernelArg(ocl->vtx_assm,  6, sizeof(cl_mem),    (void*)&ocl->dev.F1u);
    ...
    ocl->err = clSetKernelArg(ocl->vtx_assm,  9, sizeof(cl_mem),    (void*)&ocl->dev.A1c);
    ocl->err = clSetKernelArg(ocl->vtx_assm, 10, sizeof(cl_mem),    (void*)&ocl->dev.E1c);
    ocl->err = clSetKernelArg(ocl->vtx_assm, 11, sizeof(cl_mem),    (void*)&ocl->dev.Juu.ii);
    ocl->err = clSetKernelArg(ocl->vtx_assm, 12, sizeof(cl_mem),    (void*)&ocl->dev.Juu.jj);
    ocl->err = clSetKernelArg(ocl->vtx_assm, 13, sizeof(cl_mem),    (void*)&ocl->dev.Juu.vv);
    ocl->err = clSetKernelArg(ocl->vtx_assm, 14, sizeof(cl_mem),    (void*)&ocl->dev.Jcc.ii);
    ocl->err = clSetKernelArg(ocl->vtx_assm, 15, sizeof(cl_mem),    (void*)&ocl->dev.Jcc.jj);
    ocl->err = clSetKernelArg(ocl->vtx_assm, 16, sizeof(cl_mem),    (void*)&ocl->dev.Jcc.vv);
...
void ocl_final(struct ocl_obj *ocl)
{
    ...
    ocl->err = clReleaseMemObject(ocl->dev.vtx_ec);
